...
function CreateUnitsForPlayer0 takes nothing returns nothing
    ...
    set u=BlzCreateUnitWithSkin(p, 'o00X', - 1431.8, - 491.9, - 45.095, 'o00X')
    set u=BlzCreateUnitWithSkin(p, 'o00X', - 1306.8, - 428.9, - 36.205, 'o00X')
    set u=BlzCreateUnitWithSkin(p, 'h020', - 1237.0, - 524.0, - 52.249, 'h020')
    set u=BlzCreateUnitWithSkin(p, 'h020', - 1364.3, - 581.1, - 54.719, 'h020')
...
function CreateBuildingsForPlayer2 takes nothing returns nothing
    ...
    set u=BlzCreateUnitWithSkin(p, 'n00B', 6944.0, - 8672.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 7072.0, - 8736.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 7200.0, - 8800.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 7200.0, - 8992.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 7072.0, - 9184.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 6944.0, - 9184.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 7136.0, - 8928.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 7264.0, - 8928.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 7264.0, - 8864.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 7072.0, - 8864.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 6944.0, - 8864.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 6944.0, - 9056.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 7008.0, - 9056.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 7008.0, - 8992.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 7008.0, - 8800.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 7008.0, - 8608.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 7136.0, - 9056.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 6880.0, - 8608.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 6816.0, - 8672.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 7072.0, - 8992.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 7136.0, - 8736.0, 270.000, 'n00B')
...
function CreateUnitsForPlayer2 takes nothing returns nothing
    ...
    set u=BlzCreateUnitWithSkin(p, 'n00D', - 704.2, - 2290.2, 124.463, 'n00D')
    set u=BlzCreateUnitWithSkin(p, 'n00D', - 365.9, - 2294.0, 38.579, 'n00D')
    ...
    set u=BlzCreateUnitWithSkin(p, 'n00D', - 838.4, - 4982.0, 310.066, 'n00D')
endfunction
