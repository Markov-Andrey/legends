...
function CreateUnitsForPlayer0 takes nothing returns nothing
    ...
    set u=BlzCreateUnitWithSkin(p, 'h022', - 1222.7, 936.4, 265.205, 'h022')
    set u=BlzCreateUnitWithSkin(p, 'h021', - 1102.9, 941.3, 264.516, 'h021')
    set u=BlzCreateUnitWithSkin(p, 'h023', - 158.5, 1016.0, - 89.833, 'h023')
    set u=BlzCreateUnitWithSkin(p, 'h02A', - 843.7, 951.2, - 87.503, 'h02A')
    set u=BlzCreateUnitWithSkin(p, 'h020', - 992.6, 927.9, - 81.293, 'h020')
    set u=BlzCreateUnitWithSkin(p, 'o00X', - 712.5, 966.9, - 85.671, 'o00X')
    set u=BlzCreateUnitWithSkin(p, 'hfoo', - 985.0, 715.6, 0.890, 'hfoo')
    set u=BlzCreateUnitWithSkin(p, 'hkni', - 833.0, 719.1, 274.425, 'hkni')
    set u=BlzCreateUnitWithSkin(p, 'hrif', - 698.8, 775.3, 295.640, 'hrif')
    set u=BlzCreateUnitWithSkin(p, 'hmtm', - 541.8, 793.8, 298.661, 'hmtm')
    set u=BlzCreateUnitWithSkin(p, 'hgyr', - 384.0, 796.9, 258.560, 'hgyr')
    set u=BlzCreateUnitWithSkin(p, 'hgry', - 159.7, 806.7, - 79.968, 'hgry')
    set u=BlzCreateUnitWithSkin(p, 'hmpr', - 1092.8, 725.2, 91.750, 'hmpr')
    set u=BlzCreateUnitWithSkin(p, 'hsor', - 1204.7, 706.1, 330.116, 'hsor')
    set u=BlzCreateUnitWithSkin(p, 'hmtt', - 1397.7, 699.8, - 77.707, 'hmtt')
    set u=BlzCreateUnitWithSkin(p, 'hspt', - 1584.2, 694.0, 317.295, 'hspt')
    set u=BlzCreateUnitWithSkin(p, 'hdhw', 18.2, 820.0, - 88.317, 'hdhw')
    set u=BlzCreateUnitWithSkin(p, 'h01Y', - 1605.0, 852.3, - 81.954, 'h01Y')
endfunction
...
function CreateBuildingsForPlayer2 takes nothing returns nothing
    ...
    set u=BlzCreateUnitWithSkin(p, 'n00B', 672.0, 7712.0, 270.000, 'n00B')
endfunction
...
function CreateUnitsForPlayer3 takes nothing returns nothing
    ...
    set u=BlzCreateUnitWithSkin(p, 'Hpal', - 4350.9, 5844.1, 223.032, 'Hpal')
    set u=BlzCreateUnitWithSkin(p, 'hfoo', - 4416.5, 5773.9, 246.424, 'hfoo')
    set u=BlzCreateUnitWithSkin(p, 'hfoo', - 4282.6, 5740.0, 247.370, 'hfoo')
    set u=BlzCreateUnitWithSkin(p, 'hfoo', - 4454.4, 5919.2, 248.589, 'hfoo')
    set u=BlzCreateUnitWithSkin(p, 'hrif', - 4215.2, 6006.7, 179.269, 'hrif')
    set u=BlzCreateUnitWithSkin(p, 'hrif', - 4054.6, 5926.0, 262.405, 'hrif')
    set u=BlzCreateUnitWithSkin(p, 'hrif', - 4445.1, 6062.8, 213.927, 'hrif')
    set u=BlzCreateUnitWithSkin(p, 'hmpr', - 4344.1, 6021.7, 173.062, 'hmpr')
    set u=BlzCreateUnitWithSkin(p, 'hrif', - 4125.5, 5758.7, 245.112, 'hrif')
    set u=BlzCreateUnitWithSkin(p, 'hrif', - 4289.9, 6157.9, 270.404, 'hrif')
    set u=BlzCreateUnitWithSkin(p, 'hmpr', - 4210.5, 5850.9, 275.743, 'hmpr')
    set u=BlzCreateUnitWithSkin(p, 'hmtm', - 4134.4, 6089.2, 296.695, 'hmtm')
endfunction
...
function CreateBuildingsForPlayer5 takes nothing returns nothing
    ...
    set u=BlzCreateUnitWithSkin(p, 'n00C', - 1344.0, - 1472.0, 270.000, 'n00C')
    set u=BlzCreateUnitWithSkin(p, 'n00C', - 1216.0, - 1472.0, 270.000, 'n00C')
    set u=BlzCreateUnitWithSkin(p, 'n00C', - 1216.0, - 1600.0, 270.000, 'n00C')
    set u=BlzCreateUnitWithSkin(p, 'n00C', - 704.0, - 1472.0, 270.000, 'n00C')
    set u=BlzCreateUnitWithSkin(p, 'n00C', - 832.0, - 1472.0, 270.000, 'n00C')
    ...
    set u=BlzCreateUnitWithSkin(p, 'n00C', - 576.0, - 1472.0, 270.000, 'n00C')
    set u=BlzCreateUnitWithSkin(p, 'n00C', - 1472.0, - 1472.0, 270.000, 'n00C')
...
function CreateBuildingsForPlayer23 takes nothing returns nothing
    ...
    set u=BlzCreateUnitWithSkin(p, 'n00B', 2848.0, - 4576.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 2848.0, - 4704.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 2720.0, - 4640.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 2528.0, - 4832.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 2592.0, - 4896.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 2528.0, - 4960.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 2720.0, - 5088.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 2848.0, - 5152.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 2912.0, - 5024.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 2784.0, - 5024.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 2528.0, - 4896.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 2784.0, - 4832.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 2592.0, - 4832.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 2912.0, - 5088.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 3040.0, - 5024.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 2912.0, - 4960.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 2784.0, - 5088.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 3104.0, - 4576.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 3168.0, - 4448.0, 270.000, 'n00B')
    set u=BlzCreateUnitWithSkin(p, 'n00B', 3232.0, - 4640.0, 270.000, 'n00B')
endfunction
...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set u=BlzCreateUnitWithSkin(p, 'n00F', - 2312.5, 8186.9, 323.184, 'n00F')
    ...
    set u=BlzCreateUnitWithSkin(p, 'n00I', 1332.8, 6713.6, 300.350, 'n00I')
    set u=BlzCreateUnitWithSkin(p, 'n00I', - 467.6, 6860.2, 271.007, 'n00I')
    set u=BlzCreateUnitWithSkin(p, 'o00Y', 1252.8, 6809.1, 302.363, 'o00Y')
    set u=BlzCreateUnitWithSkin(p, 'o00Y', 1501.1, 7058.4, 339.423, 'o00Y')
    set u=BlzCreateUnitWithSkin(p, 'o00Y', 1451.3, 6859.7, 301.749, 'o00Y')
    ...
    set u=BlzCreateUnitWithSkin(p, 'o00Y', - 1473.6, 7647.6, 339.423, 'o00Y')
    set u=BlzCreateUnitWithSkin(p, 'o00Y', - 1721.9, 7398.3, 302.363, 'o00Y')
    set u=BlzCreateUnitWithSkin(p, 'o00Y', - 1523.4, 7448.9, 301.749, 'o00Y')
    set u=BlzCreateUnitWithSkin(p, 'n00I', - 1389.0, 7355.8, 307.795, 'n00I')
    set u=BlzCreateUnitWithSkin(p, 'n00I', - 1398.9, 7592.9, 328.642, 'n00I')
    set u=BlzCreateUnitWithSkin(p, 'n00I', - 1641.9, 7302.7, 300.350, 'n00I')
endfunction
...
function Trig_WhitemaneCrusade_Actions takes nothing returns nothing
    ...
    call ForGroupBJ(GetUnitsOfTypeIdAll('h01Y'), function Trig_WhitemaneCrusade_Func003A)
    if ( Trig_WhitemaneCrusade_Func004C() ) then
        call ForGroupBJ(GetUnitsOfTypeIdAll('h01Y'), function Trig_WhitemaneCrusade_Func004Func002A)
    else
        if ( Trig_WhitemaneCrusade_Func004Func001C() ) then
            call ForGroupBJ(GetUnitsOfTypeIdAll('h01Y'), function Trig_WhitemaneCrusade_Func004Func001Func002A)
        else
            if ( Trig_WhitemaneCrusade_Func004Func001Func001C() ) then
                call ForGroupBJ(GetUnitsOfTypeIdAll('h01Y'), function Trig_WhitemaneCrusade_Func004Func001Func001Func002A)
            else
                if ( Trig_WhitemaneCrusade_Func004Func001Func001Func001C() ) then
                    call ForGroupBJ(GetUnitsOfTypeIdAll('h01Y'), function Trig_WhitemaneCrusade_Func004Func001Func001Func001Func002A)
                else
...
function config takes nothing returns nothing
    ...
    call DefineStartLocation(4, - 2112.0, 1536.0)
