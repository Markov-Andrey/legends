...
function CreateUnitsForPlayer0 takes nothing returns nothing
    ...
    set u=BlzCreateUnitWithSkin(p, 'h023', - 406.1, 990.6, 270.167, 'h023')
    set u=BlzCreateUnitWithSkin(p, 'h020', - 992.6, 927.9, 272.118, 'h020')
    set u=BlzCreateUnitWithSkin(p, 'o00X', - 712.5, 966.9, 274.329, 'o00X')
    set u=BlzCreateUnitWithSkin(p, 'h02A', - 856.7, 943.0, 272.500, 'h02A')
    set u=BlzCreateUnitWithSkin(p, 'h01Y', - 1329.1, 928.1, 278.046, 'h01Y')
    set u=BlzCreateUnitWithSkin(p, 'h02C', - 578.1, 980.6, 273.313, 'h02C')
endfunction
