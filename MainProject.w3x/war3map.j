...
trigger gg_trg_ItemsLoot= null
unit gg_unit_n00L_0015= null
...
function CreateBuildingsForPlayer0 takes nothing returns nothing
    ...
    set u=BlzCreateUnitWithSkin(p, 'n00L', - 576.0, - 576.0, 270.000, 'n00L')
...
function CreateUnitsForPlayer0 takes nothing returns nothing
    ...
    set u=BlzCreateUnitWithSkin(p, 'H01R', - 597.7, - 377.1, 209.757, 'H01R')
...
function Trig_ItemsLoot_Actions takes nothing returns nothing
    call AddLootForUnitType('n00N' , 5)
    call AddLootForUnitType('n00L' , 6)
    call AddLootForUnitType('n00O' , 7)
endfunction

function InitTrig_ItemsLoot takes nothing returns nothing
    set gg_trg_ItemsLoot=CreateTrigger()
    call TriggerRegisterTimerEventSingle(gg_trg_ItemsLoot, 0.10)
    call TriggerAddAction(gg_trg_ItemsLoot, function Trig_ItemsLoot_Actions)
endfunction
