...
function CreateUnitsForPlayer0 takes nothing returns nothing
    ...
    set u=BlzCreateUnitWithSkin(p, 'h02W', - 498.9, - 23.9, - 49.067, 'h02W')
    call SetUnitState(u, UNIT_STATE_MANA, 100)
    set u=BlzCreateUnitWithSkin(p, 'h02T', - 560.9, 256.1, - 61.487, 'h02T')
    set u=BlzCreateUnitWithSkin(p, 'h02X', - 355.3, 101.2, - 53.172, 'h02X')
    call SetUnitState(u, UNIT_STATE_MANA, 100)
endfunction
...
function Trig_HellscreamRage_Func001C takes nothing returns boolean
    if ( not ( GetPlayerTechCountSimple('R03E', GetOwningPlayer(GetAttacker())) == 0 ) ) then
        return false
    endif
    return true
endfunction
