...
function CreateBuildingsForPlayer0 takes nothing returns nothing
    ...
    set u=BlzCreateUnitWithSkin(p, 'h02C', - 512.0, - 448.0, 270.000, 'h02C')
endfunction
...
function CreateUnitsForPlayer0 takes nothing returns nothing
    ...
    set u=BlzCreateUnitWithSkin(p, 'h020', - 189.7, - 544.2, 234.378, 'h020')
    set u=BlzCreateUnitWithSkin(p, 'h020', - 738.3, - 619.4, 205.813, 'h020')
    set u=BlzCreateUnitWithSkin(p, 'h020', - 918.5, - 526.1, 264.592, 'h020')
    set u=BlzCreateUnitWithSkin(p, 'h020', - 849.9, - 177.4, 348.068, 'h020')
    set u=BlzCreateUnitWithSkin(p, 'H01R', - 468.5, - 678.3, 215.525, 'H01R')
    set u=BlzCreateUnitWithSkin(p, 'h020', - 829.7, - 495.0, 235.532, 'h020')
    set u=BlzCreateUnitWithSkin(p, 'h020', - 702.3, - 552.0, 339.070, 'h020')
endfunction
